...
@interface DemoViewController22 () <GLKViewDelegate>
{
...
@implementation DemoViewController22
...
- (void)viewDidLoad
{
    ...
    // shader
    self.lightProgram = [[GLProgram alloc] initWithVertexShaderFilename:@"shaderv_22_0" fragmentShaderFilename:@"shaderf_22_0"];
    [self.lightProgram link];
    
    self.modelProgram = [[GLProgram alloc] initWithVertexShaderFilename:@"shaderv_22_1" fragmentShaderFilename:@"shaderf_22_1"];
...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect
{
    ...
    // 2.绘制物体
    {
        ...
        glUniform4f([self.modelProgram uniformIndex:@"material.specular"], 0.5, 0.5, 0.5, 1.0);
