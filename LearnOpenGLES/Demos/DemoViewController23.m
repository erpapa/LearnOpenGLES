...
@interface DemoViewController23 () <GLKViewDelegate>
{
...
@implementation DemoViewController23
...
- (void)viewDidLoad
{
    ...
    // shader
    self.lightProgram = [[GLProgram alloc] initWithVertexShaderFilename:@"shaderv_23_0" fragmentShaderFilename:@"shaderf_23_0"];
    [self.lightProgram link];
    
    self.modelProgram = [[GLProgram alloc] initWithVertexShaderFilename:@"shaderv_23_1" fragmentShaderFilename:@"shaderf_23_1"];
