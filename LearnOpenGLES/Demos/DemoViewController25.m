...
@interface DemoViewController25 () <GLKViewDelegate>
{
...
@implementation DemoViewController25
...
- (void)viewDidLoad
{
    ...
    // shader
    self.lightProgram = [[GLProgram alloc] initWithVertexShaderFilename:@"shaderv_25_0" fragmentShaderFilename:@"shaderf_25_0"];
    [self.lightProgram link];
    
    self.modelProgram = [[GLProgram alloc] initWithVertexShaderFilename:@"shaderv_25_1" fragmentShaderFilename:@"shaderf_25_1"];
